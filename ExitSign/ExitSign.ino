...
//unsigned long frameCounterSpotlights = 0;
//unsigned long frameCounterExit = 0;
//uint8_t exitStepper = 0;
//uint8_t spotlightScene = 0;
//uint8_t exitScene = 0;
//uint8_t repeatStepper = 0;
//uint8_t exitRepeatStepper = 0;
//uint8_t xStepper = 0;
...
//  if(exitScene == 0) {
//    rainbowExit(15);
//    if (nextFrameWithDelay(45000, &frameCounterExit)) { exitStepper = 0; exitScene++; }
//  }
//  if (exitScene == 1) {
//    cyanWipeRight(100);
//    if (exitStepper == EXIT_LEDS + 1) { exitStepper = 0; exitScene++; }
//  }
//  if (exitScene == 2) {
//    magentaWipeLeft(100);
//    if (exitStepper == EXIT_LEDS + 1) { exitStepper = 0; exitScene++; }
...
//  if(exitScene == 6) {
//    exitScene = 0;
//    nextFrameWithDelay(1, &frameCounterExit);
//  }
//}
//
//void rainbowExit(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter2)) {
//    uint32_t color = Wheel((exitStepper) & 255);
//    for(uint8_t i = 0; i < EXIT_LEDS; i++) {
//      strip.setPixelColor(i, color);
//    }
//    exitStepper = (exitStepper + 1) % 256;
//    strip.show();
//  }
//}
//void cyanWipeRight(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter2)) {
//    for(uint8_t i = 0; i < exitStepper; i++) {
//      if (i >= EXIT_LEDS) continue;
...
//  }
//}
//void magentaWipeLeft(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter2)) {
//    for(uint8_t i = 0; i < exitStepper; i++) {
//      if (i > EXIT_LEDS - 1) continue;
//      strip.setPixelColor(EXIT_LEDS - 1 - i, strip.Color(255, 0, 255));
//    }
//    exitStepper++;
//    strip.show();
//  }
//}
//void yellowWipeRight(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter2)) {
//    for(uint8_t i = 0; i < exitStepper; i++) {
//      if (i >= EXIT_LEDS) continue;
...
//  }
//}
//void whiteWipeLeft(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter2)) {
//    for(uint8_t i = 0; i < exitStepper; i++) {
//      if (i > EXIT_LEDS - 1) continue;
//      strip.setPixelColor(EXIT_LEDS - 1 - i, strip.Color(255, 255, 255));
//    }
//    exitStepper++;
//    strip.show();
//  }
...
//void spotlights() {
//  if(spotlightScene == 0) {
//    orangePinkFadeSpin(100);
//    if (nextFrameWithDelay(45000, &frameCounterSpotlights)) { spotlightScene++; }
//  }
//  
//  if(spotlightScene == 1) {
//    rainbowX(15);
...
//    if (spotlightScene == 3) {
//      cyanSingleSpin(80);
//      if (nextFrameWithDelay(1000, &frameCounterSpotlights)) { spotlightScene++; }
//    }
//    if(spotlightScene == 4) {
//      magentaSingleSpin(80);
//      if (nextFrameWithDelay(1000, &frameCounterSpotlights)) { spotlightScene++; }
//    }
//    if(spotlightScene == 5) {
//      yellowSingleSpin(80);
...
//  #if OWNER == ALLIE
//    if(spotlightScene == 3) {
//      fuschiaGreenWeeWoo(200);
//      if (nextFrameWithDelay(45000, &frameCounterSpotlights)) { spotlightScene++; }
//    }
//    if(spotlightScene == 4) {
//      orangePinkFadeWeeWoo(200);
//      if (nextFrameWithDelay(45000, &frameCounterSpotlights)) { spotlightScene++; }
//    }
//    if(spotlightScene == 5) {
//      spotlightScene = 0;
...
//
//
//void rainbowX(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    uint32_t color = Wheel((xStepper) & 255);
//    basicX(color, color, color, color, 0);
//    xStepper = (xStepper + 1) % 256;
//    strip.show();
//  }
//}
//
//void whiteSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(255, 255, 255), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//
//void redSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(255, 0, 0), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//void magentaSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(255, 0, 255), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//void greenSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(0, 255, 0), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//void yellowSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(255, 255, 0), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//void cyanSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(0, 255, 255), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//void blueSingleSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(0, 0, 255), strip.Color(0, 0, 0),  strip.Color(0, 0, 0),  strip.Color(0, 0, 0), xStepper);
//    xStepper = (xStepper + 1) % 4;
//    strip.show();
//  }
//}
//
//void orangePinkFadeSpin(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//      basicX(strip.Color(255, 144, 0), strip.Color(45, 20, 37), strip.Color(66, 0, 31), strip.Color(132, 40, 1), xStepper);
//      xStepper = (xStepper + 1) % 4;
//      strip.show();
//    }
//}
//
//void purpleFadeSpin(uint8_t d) {
//   if (nextFrameWithDelay(d, &frameCounter1)) {
//      basicX(strip.Color(220, 0, 255), strip.Color(2, 0, 35), strip.Color(17, 0, 66), strip.Color(32, 0, 79), xStepper);
//      xStepper = (xStepper + 1) % 4;
//      strip.show();
//    }
//}
//
//void orangePinkFadeWeeWoo(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//      basicX(strip.Color(255, 144, 0), strip.Color(45, 20, 37), strip.Color(66, 0, 31), strip.Color(132, 40, 1), xStepper);
//      xStepper = (xStepper + 2) % 4;
//      strip.show();
//    }
//}
//
//void fuschiaGreenWeeWoo(uint8_t d) {
//  if (nextFrameWithDelay(d, &frameCounter1)) {
//    basicX(strip.Color(255, 0, 127), strip.Color(255, 0, 127), strip.Color(0, 15, 0), strip.Color(0, 15, 0), xStepper);
//    xStepper = (xStepper + 2) % 4;
//    strip.show();
//  }
//}
